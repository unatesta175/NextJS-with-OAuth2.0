...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative h-[600px] bg-gradient-to-r from-pink-50 to-purple-50 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight">
                ...
                <span className="text-primary"> Book Today!</span>
              </h1>
              <p className="text-lg text-gray-600 leading-relaxed">
                Experience luxury wellness and rejuvenation with our premium spa treatments. 
                Professional care, serene environment, and personalized service await you.
              </p>
              <Button 
                size="lg" 
                  ...
                  {heroImages.map((_, index) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-all ${
                        index === currentHeroImage ? 'bg-primary' : 'bg-white/50'
                      }`}
                    />
                  ))}
                </div>
